...
**۴۷۴ تست پاس** (تأییدشده، همه روی داده‌ی واقعی). برای اجرا اول بخش «آماده‌سازی محیط» را ببینید.
...
| `pytest -q` | ۴۷۴ تست، روی پایتون ۳.۱۱ و ۳.۱۲ |
...
و شکننده می‌کند. (شاهدش: همین ۴۷۴ تست بدون نصب هیچ‌کدام پاس می‌شوند.)
