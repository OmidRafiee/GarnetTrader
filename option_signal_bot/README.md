...
**۵۲۴ تست پاس** (تأییدشده، همه روی داده‌ی واقعی). برای اجرا اول بخش «آماده‌سازی محیط» را ببینید.
...
| `pytest -q` | ۵۲۴ تست، روی پایتون ۳.۱۱ و ۳.۱۲ |
...
و شکننده می‌کند. (شاهدش: همین ۵۲۴ تست بدون نصب هیچ‌کدام پاس می‌شوند.)
